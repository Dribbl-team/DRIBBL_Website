...
This template can be run as a full-stack app with a Node.js backend serving the React frontend.
...
You can add your own API endpoints in `server/index.js`. Example endpoint: `/api/hello`
